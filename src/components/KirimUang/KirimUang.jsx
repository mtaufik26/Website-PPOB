...
const KirimUang = () => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate('/proses-pengiriman', {
      state: { amount, selectedBank, accountNumber, adminFee },
    });
  };
    ...
    <Card>
      <header className="sticky top-0 bg-white z-10 border-b shadow-sm">
        <div className="flex items-center p-4">
          ...
          <h1 className="text-lg font-semibold text-gray-800">Kirim Uang</h1>
        </div>
      </header>
      ...
      <section className="p-6  rounded-lg">
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            <label className="block mb-2 text-gray-700 font-medium">Mau kirim berapa?*</label>
          ...
          <div className="mb-6">
            <label className="block mb-2 text-gray-700 font-medium">Mau kirim ke mana?*</label>
            <select
              value={selectedBank}
          ...
          <div className="mb-6">
            <label className="block mb-2 text-gray-700 font-medium">No. Rekening</label>
            <div className="relative">
              <input
                type="text"
                value={accountNumber}
          ...
          {showSummary && recipientDetails && (
            <>
              ...
              <div className="mb-6">
                <h2 className="font-semibold mb-2 text-gray-800">Cek dulu ringkasannya, ya</h2>
          ...
          <div className="flex justify-between items-center mt-4 border-t pt-4">
            ...
            <button
              type="submit"
              className={`py-3 px-6 rounded-lg transition duration-300 ${isFormValid ? 'bg-sky-500 text-white' : 'bg-gray-400 text-gray-700'}`}
